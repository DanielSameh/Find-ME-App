    ...
    <ScrollView>
      <Container>
        <View style={{ marginBottom: 18 }}>
          <Typography marginTop={30} alignSelf={'center'} fontSize={'22px'} fontWeight={'bold'}>
            Register Account
          </Typography>

          <Typography fontColor={'#9FA5C0'} isParagrapgh margin={15} textAlign={'center'}>
            For the prupose of industry regulation, your details are required.
          </Typography>
        </View>
        <View
        ...
        {errors.equalPassword && (
          <Text style={styles.warningText}>{errors.equalPassword.message}</Text>
        )}
        <VerticalSpace />
        <View
          style={{ width: '80%', height: 1, backgroundColor: '#F5F5F5', borderRadius: 30 }}
        ...
        <Typography isParagrapgh margin={15} textAlign={'center'} fontSize={'12px'}>
